        ...
        <form action="" method="get">
            ...
            <div class="p-3 border-bottom">
                ...
                <div class="input-group">
                    <input type="number" name="min_price" id="min_price" class="form-controle" placeholder="Prix minimum" value=" <?php if (isset($_GET["min_price"])) {
                                                                                                                                        echo htmlspecialchars($_GET["min_price"]);
                                                                                                                                    } ?>">
                    <span class="input-group-text">€</span>
                </div>
                <div class="input-group">
                    <input type="number" name="max_price" id="max_price" class="form-controle" placeholder="Prix maximum" value=" <?php if (isset($_GET["max_price"])) {
